...
const val COLOR_APP_THEME_PURPLE_VALUE = 0xff9266ff

val ONBOARDING_SCREEN_COLOR = Color(COLOR_NIGHT_BLACK_VALUE)
val ONBOARDING_SCREEN_BUTTONS_COLOR = Color(COLOR_APP_THEME_PURPLE_VALUE)

val LOGIN_SCREEN_COLOR = Color(COLOR_NIGHT_BLACK_VALUE)
val LOGIN_SCREEN_BUTTONS_COLOR = Color(COLOR_APP_THEME_PURPLE_VALUE)

val SIGNUP_SCREEN_COLOR = Color(COLOR_NIGHT_BLACK_VALUE)
val SIGNUP_SCREEN_BUTTONS_COLOR = Color(COLOR_APP_THEME_PURPLE_VALUE)

const val SUGGESTION_ADD_DESCRIPTION = "Add Description"
const val SUGGESTION_SHOW_PREVIEW = "Show Preview"

val CREATE_PROJECT_SUGGESTION_LIST = listOf(
    SUGGESTION_ADD_DESCRIPTION,
)